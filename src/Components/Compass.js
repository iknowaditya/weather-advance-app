...
export default function Compass({ weather }) {
  const { deg, speed } = weather;

  return (
    <div className="relative -mt-3 flex h-[10rem] w-[10rem] items-center justify-center  md:h-[8rem] md:w-[8rem]">
